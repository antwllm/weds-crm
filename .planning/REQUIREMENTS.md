...
- [x] **LEAD-03**: User can view leads in a Kanban board with drag-and-drop between pipeline stages
...
- [x] **SYNC-03**: System receives Pipedrive webhook events and updates local leads accordingly
- [x] **SYNC-04**: System prevents sync loops (local change → Pipedrive webhook → local change)

### Infrastructure

- [x] **INFR-01**: User authenticates via Google OAuth 2.0
- [x] **INFR-02**: All UI text and notifications are in French
- [x] **INFR-03**: UI is responsive and usable on mobile
